...
this.Control[iCurrent+29]=this.st_string
this.Control[iCurrent+30]=this.cb_string
this.Control[iCurrent+31]=this.uo_string
this.Control[iCurrent+32]=this.em_string
this.Control[iCurrent+33]=this.em_get
this.Control[iCurrent+34]=this.em_function
this.Control[iCurrent+35]=this.em_sort
this.Control[iCurrent+36]=this.em_loop
this.Control[iCurrent+37]=this.st_3
this.Control[iCurrent+38]=this.cb_cancel
this.Control[iCurrent+39]=this.cb_function
this.Control[iCurrent+40]=this.st_function
this.Control[iCurrent+41]=this.uo_function
this.Control[iCurrent+42]=this.cb_report
this.Control[iCurrent+43]=this.cb_get
this.Control[iCurrent+44]=this.st_get
this.Control[iCurrent+45]=this.uo_get
this.Control[iCurrent+46]=this.uo_sort
this.Control[iCurrent+47]=this.cb_sort
this.Control[iCurrent+48]=this.st_2
this.Control[iCurrent+49]=this.st_1
this.Control[iCurrent+50]=this.uo_loop
this.Control[iCurrent+51]=this.cb_loop
this.Control[iCurrent+52]=this.mle_wait
